...
- Un CSV en un documneto contenedor de grandes volumenes de información
...
- Este codigo, leera la información dentro de un **CSV**
...
- Podemos usar generadores para obtener información de una pagina
- Este codigo es un ***fragmento*** donde se ve el uso de los **Generadores**
...
- 'Hace referencia al codigo de arriba ([## POO Crawler] (#poo-crawler))'
